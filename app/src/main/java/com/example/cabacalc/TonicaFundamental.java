...
public class TonicaFundamental extends AppCompatActivity {

    TextView name, contenido;
    static String Tonicafundamental = "", Urgenciainterior = "";
    static String dia, mes, año, nombre;

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tonica_fundamental);
        ...
        contenido.setText(Tonicafundamental);
    ...
    public static void TonicaFundamental(String nombre) {
        String tamaños = "";
        ...
        System.out.println(Tonicafundamental);
    }
